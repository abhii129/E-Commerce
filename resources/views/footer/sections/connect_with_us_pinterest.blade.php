...
<head>
    ...
    <style>
        ...
        .card-top {
            height: 80px;
            /* Pinterest red */
            background: linear-gradient(135deg, #bd081c 0%, #b31217 100%);
        }
        ...
        .btn {
            ...
            box-shadow: 0 4px 6px rgba(189, 8, 28, 0.2);
        }

        .btn:hover {
            background: #a0071a;
            transform: translateY(-2px);
            box-shadow: 0 6px 12px rgba(189, 8, 28, 0.3);
        }
...
<body>
    <div class="social-card">
        ...
        <div class="card-content">
            ...
            <p>Discover inspiration and ideas on our Pinterest page</p>

            @if(!empty($data['link']))
                <a href="{{ $data['link'] }}" class="btn" target="_blank" rel="noopener">
                    <i class="fab fa-pinterest-p"></i> Follow
                </a>
            @else
                <div class="no-link">
