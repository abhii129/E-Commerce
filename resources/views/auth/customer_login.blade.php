<x-guest-layout>
    <div class="max-w-md w-full mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="mt-2 text-gray-600">Sign in to access your account and start shopping</p>
        </div>

        <!-- Session Status -->
        <x-auth-session-status class="mb-4 p-4 bg-green-100 text-green-700 rounded" :status="session('status')" />
